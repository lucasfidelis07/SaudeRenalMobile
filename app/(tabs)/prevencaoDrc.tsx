...
const PrevencaoDrcScreen = () => {
  ...
  const fetchVideoUrls = async () => {
    try {
      ...
      const videoListRef = ref(storage, 'videos/prevencaodadrc/');
  ...
  return (
    <LinearGradient colors={['#CCFED9', '#96BBFE']} style={styles.container}>
      ...
      <Text style={styles.title}>PREVENÇÃO DA DRC</Text>
      <Text style={styles.description}>
        Assista aos vídeos abaixo para aprender mais sobre a prevenção da DRC.
      </Text>
...
export default PrevencaoDrcScreen;
