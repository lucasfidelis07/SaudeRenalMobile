...
const CuidadosDialiseScreen = () => {
  ...
  const fetchVideoUrls = async () => {
    try {
      ...
      const videoListRef = ref(storage, 'videos/cuidadosaopacienteemdialise/');
  ...
  return (
    <LinearGradient colors={['#CCFED9', '#96BBFE']} style={styles.container}>
      ...
      <Text style={styles.title}>CUIDADOS AO PACIENTE EM DIÁLISE</Text>
      <Text style={styles.description}>
        Assista aos vídeos abaixo para aprender mais sobre os cuidados ao paciente em diálise.
      </Text>
...
export default CuidadosDialiseScreen;
