...
const SintomasDrcScreen = () => {
  ...
  const fetchVideoUrls = async () => {
    try {
      ...
      const videoListRef = ref(storage, 'videos/sintomasdadrc/');
  ...
  return (
    <LinearGradient colors={['#CCFED9', '#96BBFE']} style={styles.container}>
      ...
      <Text style={styles.title}>SINTOMAS DA DRC</Text>
      <Text style={styles.description}>
        Assista aos vídeos abaixo para aprender mais sobre os sintomas da DRC.
      </Text>
...
export default SintomasDrcScreen;
