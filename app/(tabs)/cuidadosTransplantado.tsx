...
const CuidadosTransplantadoScreen = () => {
  ...
  const fetchVideoUrls = async () => {
    try {
      ...
      const videoListRef = ref(storage, 'videos/cuidadosaopacientetransplantado/');
  ...
  return (
    <LinearGradient colors={['#CCFED9', '#96BBFE']} style={styles.container}>
      ...
      <Text style={styles.title}>CUIDADOS AO PACIENTE TRANSPLANTADO</Text>
      <Text style={styles.description}>
        Assista aos vídeos abaixo para aprender mais sobre os cuidados ao paciente transplantado.
      </Text>
...
export default CuidadosTransplantadoScreen;
